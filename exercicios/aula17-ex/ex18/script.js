...
/*Havia um erro na linha 15: a função !inLista() estava com erro de digitação. Ao inves de IN foi escrito IS*/
...
/*A função foi chamada como inLista()*/
function adicionar() {
...
function finalizar() {
    if (valores.length == 0) {
        ...
        res.innerHTML += `<p>A média de todos valores é de ${media.toFixed(2)}.</p>`
    }
}